// ================================================================
// novoTreino.js — Lógica da página NovoTreino.html
//
// Quando o backend estiver pronto:
//   - createTreino() e createExercicio() já estão importados via api.js
//   - Basta descomentar as chamadas reais dentro de salvarTreino()
// ================================================================

const form          = document.querySelector('form.rowinput');
const btnAddRow     = document.getElementById('btnAddExercise');
const btnCancelar   = document.querySelector('.new-btn-close');
const btnConcluir   = document.querySelector('.new-btn-save');
const inputTitulo   = document.querySelector('input.new_exercice:not(.name):not(.serie):not(.reps):not(.kg)');
